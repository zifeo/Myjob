...
<body>
<table id="mail" width="100%" cellpadding="0" cellspacing="0" style="background: #f0f0f0;font-family: 'Helvetica Neue', helvetica, sans-serif;font-size: 16px;">
    <tr>
        <td class="center" style="text-align: center;padding: 15px;">
            <a href="http://my.job" style="font-family: 'Montserrat', inherit;text-decoration: none;color: rgba(0, 0, 0, .8);">
    ...
    @yield('content')
    <tr id="footer" style="border-top: 1px solid #dddddd;">
        <td class="center" style="text-align: center;padding: 15px;">
            <p>
                <a href="https://agepoly.ch" style="font-family: 'Montserrat', inherit;text-decoration: none;color: rgba(0, 0, 0, .8);">AGEPINFO</a> 2015 · <a href="https://myjob.epfl.ch/options" style="font-family: 'Montserrat', inherit;text-decoration: none;color: rgba(0, 0, 0, .8);">{{ trans('mails.notifications.options') }}</a><br>
            </p>
        </td>
    </tr>
</table>
