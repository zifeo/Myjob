...
<div class="row">
	<div class="eleven wide column">
		...
		<h2 class="ui header">
			{{ $ad->title }}
			@if (! $ad->validated)<span class="ui teal horizontal label">{{ trans('general.notyetvalidated') }}</span>@endif
		...
		<div class="align-center mt">
			...
			<a href="mailto:{{ $ad->contact_email }}?subject={{ $ad->title }}" class="ui red button mt">{{ trans('general.buttons.apply') }}</a>
		</div>
